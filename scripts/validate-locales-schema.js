 ...
 * @param {string} filePath - Path to messages.json file
 * @param {string} locale - Locale code for error messages
 * @returns {Array} Array of validation errors
 */
function validateMessageFile(filePath, locale) {
  const errors = [];
  ...
  try {
    ...
    errors.push(`Invalid JSON in ${locale}/messages.json: ${error.message}`);
    return errors;
  }
